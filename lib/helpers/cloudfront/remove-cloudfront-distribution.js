...
const { STAGE, REGION, APP_PREFIX, DOMAIN_NAME, WEB_APP_BUCKET_NAME } = require('@juquinha/config/env')
const CertificateManager = require('./certificate-manager.mjs.mjs')
const DistributionManager = require('./distribution-manager.mjs')

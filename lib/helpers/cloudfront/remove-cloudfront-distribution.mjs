import { STAGE, REGION, APP_PREFIX, DOMAIN_NAME, WEB_APP_BUCKET_NAME } from '@juquinha/config/env.mjs'
import CertificateManager from './certificate-manager.mjs'
import DistributionManager from './distribution-manager.mjs'

const certificateManager = new CertificateManager()
const distributionManager = new DistributionManager()

export default async ({ domain = DOMAIN_NAME }) => {

import * as cache from '@juquinha/lib/cache/index.mjs'
import AccessLogsService from '@juquinha/lib/services/access-logs/index.mjs'
import { genericError } from '@juquinha/lib/helpers/response-builder.mjs'
...
const postRequest = async (request, response, error) => {
  ...
  if (error) {
    const errorPayload = genericError(error)
